...
<%
	...
	<form  class="form-horizontal" id='frmUsuarios' action="TesteUsuarios.jsp" method='POST'>
                ...
                <input type='text' class='form-control' id='idusuario' placeholder='Enter idusuario' name='idusuario'>
                </div>
                ...
                <button type="button" id='btnUsuarios' class='btn btn-primary' onclick=" acao.value='2'; this.form.submit(); " > Excluir </button> </br></br>               
       			<button type="button" value="Alterar" class="btn btn-primary" onClick="acao.value='1'; this.form.submit();" > Alterar </button>
